...
const u32 gObjectEventPic_ProfSyurp[] = INCBIN_U32("graphics/object_events/pics/people/gulpin_swalot/prof_syurp.4bpp");
...
const u16 gObjectEventPal_Swalot[] = INCBIN_U16("graphics/object_events/palettes/swalot_1.gbapal");
