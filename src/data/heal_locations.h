static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(PETALBURG_CITY), MAP_NUM(PETALBURG_CITY), 22, 16},
    ...
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(RUSTBORO_CITY), MAP_NUM(RUSTBORO_CITY), 18, 39},
    ...
    [HEAL_LOCATION_BERSKET_CITY - 1] = {MAP_GROUP(BERSKET_CITY), MAP_NUM(BERSKET_CITY), 15, 36},
    [HEAL_LOCATION_RUSTYPETAL_HARBOR - 1] = {MAP_GROUP(RUSTYPETAL_HARBOR), MAP_NUM(RUSTYPETAL_HARBOR), 25, 25},
    [HEAL_LOCATION_HONEYDEW_HAMLET - 1] = {MAP_GROUP(HONEYDEW_HAMLET), MAP_NUM(HONEYDEW_HAMLET), 28, 6},
};
