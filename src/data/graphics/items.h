...
const u32 gItemIcon_SurfEngram[] = INCBIN_U32("graphics/items/icons/surf_engram.4bpp.lz");
const u32 gItemIconPalette_SurfEngram[] = INCBIN_U32("graphics/items/icon_palettes/surf_engram.gbapal.lz");
